...
class AppConfig {
  ...
  static const icon = AppConfig.rutaIcon + "icon.png";
  ...
  static const pantallaAnexarse = "pantallaAnexarse";
  ...
  static const IconData iconMarcadorRastro= Icons.check_circle;
   ...
   static Map<String, WidgetBuilder> getRoutes(BuildContext context) {
    Map<String, WidgetBuilder> routes = {
      ...
      AppConfig.pantallaBienvenida: (context) => BienvenidaPage(),
      ...
      AppConfig.pantallaConfigApp: (context) => ConfigAppPage(),

      AppConfig.pantallaMenuCrearCodigo: (context) => MenuCrearCodigoPage(),


      //operativoProcesoElectoral
      //Menu

      //Menu opcion 1  Seleccionar Operativo
      AppConfig.pantallaProcesosOperativos: (context) => selectProcesosOperativosPage(),
      // opcion 1.1 Selecionar el tipo de servicio
      AppConfig.pantallaTipoEjes: (context) => SelectTipoServiciosEjesPage(),
      //1.1.1 Servicio en Recintos


      //1.1.2 Unidades Policiales
      ...
      AppConfig.pantallaAnexarse: (context) => AnexarsePage(),
      AppConfig.pantallaRecElecRegistrarNovedades: (context) => registrarNovedadesPage(),
      AppConfig.pantallaRecElecAddPersonal: (context) => AddPersonalPage(),
      AppConfig.pantallaRecElecPersonalDetalle: (context) => PersonalDetallePage(),
      AppConfig.pantallaRecElecNovedadesDetalle: (context) => NovedadesDetallePage(),
