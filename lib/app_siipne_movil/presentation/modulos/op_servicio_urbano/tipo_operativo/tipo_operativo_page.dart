...
Expanded(
child: Text(
'Operativo compatible y ubicado a '
'${controller.distanciaAnexarseMetros.value.toStringAsFixed(0)} metros. '
'Disponible para anexarse.',
style: const TextStyle(
...
final bool navegacionIniciada = await controller.anexarseOperativo(data);
...
_dialogoErrorAnexarse(
context,
controller.mensajeErrorAnexarse.isEmpty
? 'No fue posible anexarse al operativo.'
    : controller.mensajeErrorAnexarse,
);
}
}
}
