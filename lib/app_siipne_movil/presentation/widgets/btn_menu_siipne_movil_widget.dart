...
class _BtnMenuSiipneMovilWidgetState extends State<BtnMenuSiipneMovilWidget> {
  ...
  String _getImagenModulo(){
    ...
    if(
    titulo.contains('MOVILES OPERATIVOS PREVENTIVOS')||
    ...
    if(
    titulo.contains('MOVILES TRANSITO')||
    ...
    if(
    titulo.contains('MOVILES METRO')||
        titulo.contains('MOVIL METRO')
    ){
