...
class SiipneConfig {
  ...
  static const double tamTextoTitulo = 3.0; //tamaño del texto en porcentaje
  static const double tamTexto = 2.5; //tamaño del texto en porcentaje
  ...
  static const int idGenTipoTipificacionEcu_OperativoUer  = 21307; //21271=OPERATIVO UER
  ...
  static const int idGenModulo_OperativoPolco  = 37; //Móviles Operativos Polco (37=Pruebas y Produccion, 44Desarrollo, )
  static const int idGenModulo_OperativoUer  = 63; //Móviles Operativos Polco (37=Pruebas y Produccion, 44Desarrollo, )
  ...
  static List<DataCatalogoTipoConsulta> catalogoTipoConsultaPersonas=[];
  static List<DataCatalogoTipoConsulta> catalogoTipoConsultaVehiculos=[];
