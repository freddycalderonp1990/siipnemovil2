...
class OpePersonaModel {
  ...
  int statusCode;
  String message;
  OpePersonaModelData data;

  factory OpePersonaModel.fromJson(String str) {
    print("OpePersonaModel.fromJson");
    log(str);
    return OpePersonaModel.fromMap(json.decode(str));
  }

  factory OpePersonaModel.fromMap(Map<String, dynamic> json) => OpePersonaModel(
    ...
    data: ParseModel.parseToBool(json["success"])
        ? OpePersonaModelData.fromMap(json["data"])
        : OpePersonaModelData.empty(),
  );
}

class OpePersonaModelData {
  OpePersonaModelData({
  ...
  factory OpePersonaModelData.empty() => OpePersonaModelData(
    operativoCerrado: true,
  ...
  factory OpePersonaModelData.fromJson(String str) =>
      OpePersonaModelData.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OpePersonaModelData.fromMap(Map<String, dynamic> json) =>
      OpePersonaModelData(
        operativoCerrado: json["operativoCerrado"] == null
            ? false
            : json["operativoCerrado"],
  ...
  Map<String, dynamic> toMap() => {
    ...
    "dataDinardap": dataDinardap == null ? null : dataDinardap.toMap(),
    "ordenCaptura": ordenCaptura == null ? null : ordenCaptura.toMap(),
    "desaparecidoDinased": desaparecidoDinased == null
        ? null
        : desaparecidoDinased.toMap(),
    "alertaDNA": alertaDna == null ? null : alertaDna.toMap(),
    "alertaInmediataPj": alertaInmediataPj == null
        ? null
        : alertaInmediataPj.toMap(),
...
class AlertaDna {
  AlertaDna({required this.success, required this.message, required this.data});
  ...
  factory AlertaDna.fromMap(Map<String, dynamic> json) => AlertaDna(
    success: ParseModel.parseToBool(json["success"]),
    message: ParseModel.parseToString(json["message"]),
    data: json["data"] == null
        ? AlertaDnaData.empty()
...
class AlertaDnaData {
  ...
  factory AlertaDnaData.empty() => AlertaDnaData(
    idGenPersona: 0,
    descripcion: "",
    fechaParte: "",
    numCasoJef: "",
  ...
  factory AlertaDnaData.fromMap(Map<String, dynamic> json) => AlertaDnaData(
...
class AlertaInmediataPj {
  ...
  factory AlertaInmediataPj.empty() => AlertaInmediataPj(
    success: false,
    message: "",
    data: AlertaInmediataPjData.empty(),
  );
...
class AlertaInmediataPjData {
  ...
  factory AlertaInmediataPjData.empty() => AlertaInmediataPjData(
    idGenPersona: 0,
    descripcion: "",
    unidadComunicar: "",
  ...
  factory AlertaInmediataPjData.fromMap(Map<String, dynamic> json) =>
      AlertaInmediataPjData(
        ...
        telefonoAlertaInmediata: ParseModel.parseToString(
          json["telefonoAlertaInmediata"],
        ),
        urlFotoAlertaInmediata: ParseModel.parseToString(
          json["urlFotoAlertaInmediata"],
        ),
      );
  ...
  Map<String, dynamic> toMap() => {
    ...
    "telefonoAlertaInmediata": telefonoAlertaInmediata == null
        ? null
        : telefonoAlertaInmediata,
    "urlFotoAlertaInmediata": urlFotoAlertaInmediata == null
        ? null
        : urlFotoAlertaInmediata,
  };
}
...
class DataDinardap {
  ...
  factory DataDinardap.empty() =>
      DataDinardap(success: false, message: "", data: DataDinardapData.empty());
  ...
  factory DataDinardap.fromMap(Map<String, dynamic> json) => DataDinardap(
    success: ParseModel.parseToBool(json["success"]),
    message: ParseModel.parseToString(json["message"]),
    data: json["data"] == null
...
class DataDinardapData {
  ...
  factory DataDinardapData.empty() => DataDinardapData(
    cedula: "",
    nombre: "",
    genero: "",
    fechaNacimiento: "",
  ...
  factory DataDinardapData.fromMap(Map<String, dynamic> json) =>
      DataDinardapData(
        ...
        individualDactilar: ParseModel.parseToString(
          json["individualDactilar"],
        ),
...
class DataSiipne {
  ...
  factory DataSiipne.fromMap(Map<String, dynamic> json) => DataSiipne(
    success: ParseModel.parseToBool(json["success"]),
    message: ParseModel.parseToString(json["message"]),
    data: json["data"] == null
...
class DataSiipneData {
  ...
  factory DataSiipneData.empty() => DataSiipneData(
    idGenPersona: 0,
    documento: "",
    apenom: "",
    codigoDactilar: "",
  ...
  factory DataSiipneData.fromMap(Map<String, dynamic> json) => DataSiipneData(
    idGenPersona: ParseModel.parseToInt(json["idGenPersona"]),
...
class DatosAnt {
  ...
  factory DatosAnt.fromMap(Map<String, dynamic> json) => DatosAnt(
    success: ParseModel.parseToBool(json["success"]),
    message: ParseModel.parseToString(json["message"]),
    data: json["data"] == null
        ? DatosAntData.empty()
...
class DatosAntData {
  ...
  factory DatosAntData.empty() => DatosAntData(
  ...
  factory DatosAntData.fromMap(Map<String, dynamic> json) => DatosAntData(
...
class Infracciones {
  ...
  factory Infracciones.fromMap(Map<String, dynamic> json) => Infracciones(
...
class DatosInfracione {
  ...
  factory DatosInfracione.fromMap(Map<String, dynamic> json) => DatosInfracione(
...
class Licencia {
  ...
  factory Licencia.fromMap(Map<String, dynamic> json) => Licencia(
    fechaDesde: ParseModel.parseToString(
      json["fechaDesde"],
    ).replaceAll("00:00:00", ""),
    fechaHasta: ParseModel.parseToString(
      json["fechaHasta"],
    ).replaceAll("00:00:00", ""),
...
class DesaparecidoDinased {
  ...
  factory DesaparecidoDinased.empty() => DesaparecidoDinased(
    success: false,
    message: "",
    data: DesaparecidoDinasedData.empty(),
  );
...
class DesaparecidoDinasedData {
  DesaparecidoDinasedData({
    required this.idUpcAlertaDesaparecido,
    required this.descripcion,
  ...
  factory DesaparecidoDinasedData.empty() => DesaparecidoDinasedData(
  ...
  factory DesaparecidoDinasedData.fromMap(Map<String, dynamic> json) =>
      DesaparecidoDinasedData(
        idUpcAlertaDesaparecido: ParseModel.parseToInt(
          json["idUpcAlertaDesaparecido"],
        ),
        descripcion: ParseModel.parseToString(json["descripcion"]),
        ...
        lugarDesaparicion: ParseModel.parseToString(json["lugarDesaparicion"]),
        nombres: ParseModel.parseToString(json["nombres"]),
      );

  Map<String, dynamic> toMap() => {
    "idUpcAlertaDesaparecido": idUpcAlertaDesaparecido == null
        ? null
...
class OrdenCaptura {
  ...
  factory OrdenCaptura.fromMap(Map<String, dynamic> json) => OrdenCaptura(
    success: ParseModel.parseToBool(json["success"]),
    message: ParseModel.parseToString(json["message"]),
    data: json["data"] == null
...
class OrdenCapturaData {
  ...
  factory OrdenCapturaData.empty() => OrdenCapturaData(
    idGenPersona: 0,
    juzgado: "",
    documento: "",
    numoficio: "",
...
class ToqueQueda {
  ToqueQueda({required this.success, required this.message});
  ...
  factory ToqueQueda.fromMap(Map<String, dynamic> json) => ToqueQueda(
    success: ParseModel.parseToBool(json["success"]),
    message: ParseModel.parseToString(json["message"]),
  );
...
class Foto {
  Foto({required this.success, required this.fotoBase64});
