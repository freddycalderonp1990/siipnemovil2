...
ActualizaResultadoModel actualizaResultadoModelFromJson(String str) => ActualizaResultadoModel.fromJson(json.decode(str));

String actualizaResultadoModelToJson(ActualizaResultadoModel data) => json.encode(data.toJson());
...
class ActualizaResultadoModel {
  ...
  factory ActualizaResultadoModel.fromJson(Map<String, dynamic> json) => ActualizaResultadoModel(
...
class ActualizaResultado {
  ...
  factory ActualizaResultado.fromJson(Map<String, dynamic> json) => ActualizaResultado(
