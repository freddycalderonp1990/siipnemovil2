...
class UrlApiProviderAppCenso {
  ...
  static String _extraerMensajeBackend(
      String body, {
        String fallback='',
      }){
    ...
    try{
      ...
      debugPrint(
        'NO FUE POSIBLE PARSEAR MENSAJE BACKEND: $e',
      );
    }
  ...
  static Future<String> _request({
    ...
    final UrlApiProviderApp urlApiProviderApp=
    UrlApiProviderApp();
    ...
    try{
      ...
      switch(metodoHttp){
        ...
        default:
          throw Exception(
            'Método HTTP no soportado: $metodoHttp',
          );
      }
      ...
      final String mensajeBackend=
      _extraerMensajeBackend(
        responseBody,
        fallback:
  ...
  static Future<String> post({
     ...
     */
    if(isLogin){
      final UrlApiProviderApp provider=
      UrlApiProviderApp();
  ...
  static Future<String> downloadPdfOperativo({
    ...
    try{
      ...
      final Uri uri=Uri.parse(
        '$hostRaiz$pathReporte',
      ).replace(
        queryParameters:{
          'idGenUsuario':
          idGenUsuario.toString(),
          'idHdrEvento':
      ...
      debugPrint(
        'PDF OPERATIVO -> REQUEST',
      );
      debugPrint(
        'ID GEN USUARIO: $idGenUsuario',
      );
      debugPrint(
      ...
      if(response.statusCode!=200){
        ...
        _extraerMensajeBackend(
          respuesta,
          fallback:
          'Error al obtener el reporte PDF.',
        );
      ...
      final Directory directorioPdf=
      Directory(
        '${tempDir.path}/siipne_movil_pdf',
      );

      if(
      !await directorioPdf.exists()
      ){
        await directorioPdf.create(
          recursive:true,
        );
      }
      ...
      debugPrint(
        'PDF OPERATIVO DESCARGADO CORRECTAMENTE',
      );
      debugPrint(
        'ARCHIVO: $filePath',
      );
