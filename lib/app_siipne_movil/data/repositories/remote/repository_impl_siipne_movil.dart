...
class SiipneMovilRepositoryImpl extends SiipneMovilRepository {
  ...
  Future<DataCreateOp> crearOperativo({
    ...
    return await siipneMovilRemoteDataSource.crearOperativo(request: request);
  }
  ...
  Future<DataConsultaPersona> consultarPersona({
    ...
    return await siipneMovilRemoteDataSource.consultarPersona(request: request);
  }
  ...
  Future<Acuerdo> insertaAcuerdo({
    ...
    return await siipneMovilRemoteDataSource.insertaAcuerdo(request: request);
  }
  ...
  Future<ActualizaResultado> actualizaResultado({
    ...
    return await siipneMovilRemoteDataSource.actualizaResultado(
      request: request,
    );
  }
  ...
  Future<ResultadosOperativo> getDatosResultadosOperativo({
    ...
    return await siipneMovilRemoteDataSource.getDatosResultadosOperativo(
      request: request,
    );
  }
  ...
  Future<DataAntecedentes> getDatosAntecedentes({
    ...
    return await siipneMovilRemoteDataSource.getDatosAntecedentes(
      request: request,
    );
  }
}
