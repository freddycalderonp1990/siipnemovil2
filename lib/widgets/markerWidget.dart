...
class MarkerRadioButton extends StatefulWidget {
  ...
  const MarkerRadioButton(
      {this.key, this.isCheck = false, this.valueCheck = true, this.onTap, this.size = 38.0, this.icon, this.colorIcon = Colors
          .blue, this.colorRelleno = Colors.white, this.onLongPress,this.num});
...
class MarkerWidget extends StatefulWidget {
  ...
  final GestureTapCallback onTap;
  const MarkerWidget(
      {this.key, this.size = 38.0, this.icon, this.colorIcon = Colors
          .blue, this.colorRelleno = Colors.white,this.sizeIcon=10, this.onTap});
