...
class AcuerdoAppPage extends GetView<AcuerdoAppController> {
  ...
  Widget build(BuildContext context) {
     ...
     */
      if (controller.verificandoAcuerdoInicial.value ||
  ...
  Widget _alerta() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFFFD670)),
      ),
      child: const Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.warning_amber_rounded, color: Color(0xFFB77900), size: 21),
  ...
  Widget _acciones() {
    return Row(
      children: [
        Expanded(flex: 2, child: _botonContinuar()),

        const SizedBox(width: 8),

        Expanded(child: _botonSalir()),
      ],
    );
  }
  ...
  Widget _botonContinuar() {
    return Obx(
      () => ElevatedButton.icon(
        onPressed: controller.puedeContinuar ? _confirmarAceptacion : null,
