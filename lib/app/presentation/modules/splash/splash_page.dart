...
class SplashPage extends GetView<SplashController> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(statusBarColor:AppColors.colorPrimary,statusBarIconBrightness:Brightness.light,statusBarBrightness:Brightness.dark,systemNavigationBarColor:AppColors.colorPrimary,systemNavigationBarIconBrightness:Brightness.light));
                ...
                child:Padding(
                  ...
                  child:TweenAnimationBuilder<double>(
                    ...
                    child:Container(
                      ...
                      padding:EdgeInsets.symmetric(horizontal:responsive.anchoP(6),vertical:responsive.altoP(3)),
                      decoration:BoxDecoration(
                        color:Colors.white.withOpacity(.08),
                        borderRadius:BorderRadius.circular(28),
                        border:Border.all(color:Colors.white.withOpacity(.14),width:1),
                        boxShadow:[
                          BoxShadow(color:Colors.black.withOpacity(.12),blurRadius:28,offset:const Offset(0,12)),
                        ],
                      ),
                      child:Column(
                        ...
                        children:[
                          Container(
                            padding:EdgeInsets.symmetric(horizontal:responsive.anchoP(3),vertical:responsive.altoP(1.2)),
                            child:Image.asset(
                          ...
                          SizedBox(
                            ...
                            child:Image.asset(AppImages.imgloginPoliciaEcuador,fit:BoxFit.contain),
                          ),
