...
class DialogosAwesome {
    ...
    AwesomeDialog(
      ...
      btnCancel: BtnIconWidget(
        ...
        onPressed: () {
          ...
          Get.back();
          Future.delayed(const Duration(milliseconds: 100), btnOkOnPress);
        },
        titulo: titleBtnSi,
      ),
            ...
            children: <Widget>[
              ...
              BotonesWidget(
                ...
                onPressed: () async {
                  ...
                  final bool result = await loginController.validarPass(pass);
  ...
  static getPersonalizado({
    ...
    AwesomeDialog(
      ...
      context: Get.context!,
      animType: AnimType.scale,
      customHeader: const Icon(Icons.face, size: 50, color: Colors.black),
      title: title,
      desc: descripcion,
      btnOk: TextButton(
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          foregroundColor: AppColors.colorRojo_60,
                          side: BorderSide(color: AppColors.colorRojo_60),
                        ),
                      ),
                    ),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(15),
                          border: Border.all(color: const Color(0xFFA7C6E3)),
                        ),
                        child: const Row(
