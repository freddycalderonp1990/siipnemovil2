...
class BtnIconWidget extends StatelessWidget {
  ...
  const BtnIconWidget({
    ...
    this.sizeTexto = AppConfig.tamTexto,
    this.sizeIcon = AppConfig.tamIcons,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Widget iconWd = icon == null ? Container() : Icon(icon, color: colorIcon);
    ...
    wg = Container(
      ...
      child: titulo == null
          ...
          : TextButton.icon(
              ...
              icon: Container(
                height: responsive.diagonalP(sizeIcon),
                child: iconWd,
              ),
