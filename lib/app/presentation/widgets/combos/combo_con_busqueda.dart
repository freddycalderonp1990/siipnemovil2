...
class _ComboConBusquedaState extends State<ComboConBusqueda> {
  ...
  Rx<ModelDataCombo> dataSelect=ModelDataCombo(id: 0, titulo: "",imgUrl: null,imgString: null).obs;
                        ...
                        child: InkWell(
                            ...
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:widget.selectValue==null?Colors.white: widget.selectValue!.value == data_[i]
                                        ? Colors.blueAccent
                                        : Colors.white,
        ...
        child: InkWell(
            ...
            child: Container(
                ...
                child: Container(
                    ...
                    Row(children: [
                      Obx(()=>getIcon(iconString:dataSelect.value.imgString,iconUrl: dataSelect.value.imgUrl,detalle: ""))  ,
...
class ModelDataCombo {
  ...
  ModelDataCombo(
      {required this.id, required this.titulo,  this.imgString,this.imgUrl,});
}
