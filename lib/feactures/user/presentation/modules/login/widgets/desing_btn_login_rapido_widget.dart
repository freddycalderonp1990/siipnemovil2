      ...
      child: InkWell(
        ...
        child: Ink(
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(22),
            border: Border.all(color: azul.withOpacity(.10), width: 1),
            boxShadow: [
              BoxShadow(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: azul.withOpacity(.08)),
                  ),
                  child: Icon(icon, size: 32, color: azul),
                ),
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 4),
                      Icon(Icons.arrow_forward_rounded, size: 14, color: azul),
                    ],
                  ),
                ),
              ],
