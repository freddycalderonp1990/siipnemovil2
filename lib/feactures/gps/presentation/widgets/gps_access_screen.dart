      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFFD7E3EF), width: 1),
            boxShadow: [
              BoxShadow(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: const LinearProgressIndicator(
                  ...
                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF195BA6)),
                ),
              ),
...
class _AccessButton extends StatelessWidget {
  ...
  const _AccessButton({super.key, required this.namApps});
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (onPressed != null) _btnContinuar(onPressed!),
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          child: const Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.my_location_rounded, color: Colors.white, size: 19),
              SizedBox(width: 8),
              Text(
                "CONTINUAR",
                style: TextStyle(
  ...
  Widget _cardPrivacidad() {
    return Container(
      ...
      child: const Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.shield_outlined, color: Color(0xFF195BA6), size: 20),
    ...
    return Column(
      ...
      children: [
        ...
        _itemPermiso(
          ...
          detalle:
              "Registrar correctamente la ubicación durante los procesos institucionales.",
        ),
      ],
    );
  }
...
class _EnableGpsMessage extends StatelessWidget {
  ...
  const _EnableGpsMessage({super.key, required this.namApps});
